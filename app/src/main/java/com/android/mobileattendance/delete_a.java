...
public class delete_a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_a);
    ...
    private void exitBtn() {
        Toast.makeText(delete_a.this, "Exit Success", Toast.LENGTH_SHORT).show();
        Intent login = new Intent(delete_a.this, login.class);
        startActivity(login);
        finish();
    }

    private void deletebtn() {
        Intent login = new Intent(delete_a.this, delete_b.class);
    ...
    private void searchBtn() {
        ...
        if (strsearch.equals("user2")){
            Intent login = new Intent(delete_a.this, delete_a.class);
            login.putExtra("username", usernameTxt);
            login.putExtra("clock_in_date", clock_in_date);
            login.putExtra("clock_out_date", clock_out_date);
            login.putExtra("clock_in_time", clock_in_time);
            ...
            Intent login = new Intent(delete_a.this, delete_c.class);
            login.putExtra("username", usernameTxt);
            login.putExtra("clock_in_date", clock_in_date);
            login.putExtra("clock_out_date", clock_out_date);
            login.putExtra("clock_in_time", clock_in_time);
    ...
    private void backBtn() {
        if (usernameTxt.equals("Admin")) {
            Intent adminHome = new Intent(delete_a.this, adminHome.class);
            ...
            Intent userHome = new Intent(delete_a.this, userHome.class);
