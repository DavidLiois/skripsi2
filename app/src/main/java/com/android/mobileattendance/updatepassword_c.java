...
public class updatepassword_c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatepassword_c);
    ...
    private void exitBtn() {
        Toast.makeText(updatepassword_c.this, "Exit Success", Toast.LENGTH_SHORT).show();
        Intent login = new Intent(updatepassword_c.this, login.class);
        startActivity(login);
        finish();
    }
    ...
    private void searchBtn() {
        ...
        if (strsearch.equals("user2")){
            Intent login = new Intent(updatepassword_c.this, updatepassword_a.class);
            ...
            Intent login = new Intent(updatepassword_c.this, updatepassword_c.class);
            login.putExtra("username", usernameTxt);
            login.putExtra("clock_in_date", clock_in_date);
            login.putExtra("clock_out_date", clock_out_date);
            login.putExtra("clock_in_time", clock_in_time);
    ...
    private void backBtn() {
        if (usernameTxt.equals("Admin")) {
            Intent adminHome = new Intent(updatepassword_c.this, adminHome.class);
            ...
            Intent userHome = new Intent(updatepassword_c.this, userHome.class);
